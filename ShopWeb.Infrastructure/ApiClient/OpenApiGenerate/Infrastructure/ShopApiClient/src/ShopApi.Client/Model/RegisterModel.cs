...
namespace ShopApi.Client.Model
{
    ...
    public partial class RegisterModel : IValidatableObject
    {
        ...
        public RegisterModel(string name = default(string), string surname = default(string), string username = default(string), string email = default(string), string password = default(string), string confirmPassword = default(string))
        {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Surname, length must be less than 50.", new [] { "Surname" });
            }
