...
namespace ShopWeb.Infrastructure.ApiClient.OpenApiGenerate.Api
{
    ...
    public partial class InventoryApi : IDisposable, IInventoryApi
    {
        ...
        public ShopWeb.Infrastructure.ApiClient.OpenApiGenerate.Infrastructure.ApiResponse<CommonInventoryPosition> ApiInventoryAddCommonInventoryPositionPostWithHttpInfo(CommonInventoryPosition? commonInventoryPosition = default)
        {
            ...
            {
                Exception _exception = this.ExceptionFactory("ApiInventoryAddCommonInventoryPositionPost", localVarResponse);
        ...
        public ShopWeb.Infrastructure.ApiClient.OpenApiGenerate.Infrastructure.ApiResponse<InventoryPosition> ApiInventoryAddInventoryPositionPostWithHttpInfo(InventoryPosition? inventoryPosition = default)
        {
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ApiInventoryAddInventoryPositionPost", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <returns>int</returns>
        public int ApiInventoryCreateInventoryPost(Inventory? inventory = default)
        {
            ShopWeb.Infrastructure.ApiClient.OpenApiGenerate.Infrastructure.ApiResponse<int> localVarResponse = ApiInventoryCreateInventoryPostWithHttpInfo(inventory);
            return localVarResponse.Data;
        }
        ...
        public ShopWeb.Infrastructure.ApiClient.OpenApiGenerate.Infrastructure.ApiResponse<int> ApiInventoryCreateInventoryPostWithHttpInfo(Inventory? inventory = default)
        {
            ShopWeb.Infrastructure.ApiClient.OpenApiGenerate.Infrastructure.RequestOptions localVarRequestOptions = new ShopWeb.Infrastructure.ApiClient.OpenApiGenerate.Infrastructure.RequestOptions();
            ...
            localVarRequestOptions.Data = inventory;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<int>("/api/Inventory/CreateInventory", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ApiInventoryCreateInventoryPost", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        public async System.Threading.Tasks.Task<int> ApiInventoryCreateInventoryPostAsync(Inventory? inventory = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ShopWeb.Infrastructure.ApiClient.OpenApiGenerate.Infrastructure.ApiResponse<int> localVarResponse = await ApiInventoryCreateInventoryPostWithHttpInfoAsync(inventory, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ShopWeb.Infrastructure.ApiClient.OpenApiGenerate.Infrastructure.ApiResponse<int>> ApiInventoryCreateInventoryPostWithHttpInfoAsync(Inventory? inventory = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<int>("/api/Inventory/CreateInventory", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public ShopWeb.Infrastructure.ApiClient.OpenApiGenerate.Infrastructure.ApiResponse<List<InventoryPosition>> ApiInventoryGetAllInventoryPositionsForUserGetWithHttpInfo(int? inventoryId = default, int? userId = default)
        {
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ApiInventoryGetAllInventoryPositionsForUserGet", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        public ShopWeb.Infrastructure.ApiClient.OpenApiGenerate.Infrastructure.ApiResponse<List<InventoryPosition>> ApiInventoryGetAllInventoryPositionsGetWithHttpInfo(int? inventoryId = default)
        {
            ...
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ApiInventoryGetAllInventoryPositionsGet", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <exception cref="ShopWeb.Infrastructure.ApiClient.OpenApiGenerate.Infrastructure.ApiException">Thrown when fails to make API call</exception>
        /// <param name="inventoryId"> (optional)</param>
        /// <returns>List&lt;SummaryInventoryPosition&gt;</returns>
        public List<SummaryInventoryPosition> ApiInventoryGetAllSummaryPositionsGet(int? inventoryId = default)
        {
            ShopWeb.Infrastructure.ApiClient.OpenApiGenerate.Infrastructure.ApiResponse<List<SummaryInventoryPosition>> localVarResponse = ApiInventoryGetAllSummaryPositionsGetWithHttpInfo(inventoryId);
            return localVarResponse.Data;
        }
        ...
        /// <exception cref="ShopWeb.Infrastructure.ApiClient.OpenApiGenerate.Infrastructure.ApiException">Thrown when fails to make API call</exception>
        /// <param name="inventoryId"> (optional)</param>
        /// <returns>ApiResponse of List&lt;SummaryInventoryPosition&gt;</returns>
        public ShopWeb.Infrastructure.ApiClient.OpenApiGenerate.Infrastructure.ApiResponse<List<SummaryInventoryPosition>> ApiInventoryGetAllSummaryPositionsGetWithHttpInfo(int? inventoryId = default)
        {
            ShopWeb.Infrastructure.ApiClient.OpenApiGenerate.Infrastructure.RequestOptions localVarRequestOptions = new ShopWeb.Infrastructure.ApiClient.OpenApiGenerate.Infrastructure.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<List<SummaryInventoryPosition>>("/api/Inventory/GetAllSummaryPositions", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ApiInventoryGetAllSummaryPositionsGet", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="inventoryId"> (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;SummaryInventoryPosition&gt;</returns>
        public async System.Threading.Tasks.Task<List<SummaryInventoryPosition>> ApiInventoryGetAllSummaryPositionsGetAsync(int? inventoryId = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ShopWeb.Infrastructure.ApiClient.OpenApiGenerate.Infrastructure.ApiResponse<List<SummaryInventoryPosition>> localVarResponse = await ApiInventoryGetAllSummaryPositionsGetWithHttpInfoAsync(inventoryId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="inventoryId"> (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;SummaryInventoryPosition&gt;)</returns>
        public async System.Threading.Tasks.Task<ShopWeb.Infrastructure.ApiClient.OpenApiGenerate.Infrastructure.ApiResponse<List<SummaryInventoryPosition>>> ApiInventoryGetAllSummaryPositionsGetWithHttpInfoAsync(int? inventoryId = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<SummaryInventoryPosition>>("/api/Inventory/GetAllSummaryPositions", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
